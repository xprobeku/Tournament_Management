...
public class FirstFragment extends Fragment {
    ...
    private ChoosePlayerAdapter playersRecyclerAdapter;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            player_ids = getArguments().getStringArrayList("ids");
            for(String s: player_ids){
                players.add(databaseHelper.getPlayer(Integer.parseInt(s)));
            }
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_first, container, false);
            recyclerViewPlayers = (RecyclerView)view.findViewById(R.id.choosePlayerAdapter);
            listPlayers = new ArrayList<>();
            playersRecyclerAdapter = new ChoosePlayerAdapter(listPlayers,getActivity());
